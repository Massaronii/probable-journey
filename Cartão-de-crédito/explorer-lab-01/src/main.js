...
cardNumberMasked.on("accept", () => {
  const number = cardNumberMasked.value.replace(/\D/g, "") 

  const foundPattern = cardNumberPattern.mask.find((pattern) => {
    return number.match(pattern.regex)
  })

  const cardType = foundPattern ? foundPattern.cardtype : "default"
